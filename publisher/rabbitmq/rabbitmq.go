...
//New Creates a pointer to a new Rabbitmq struct
...
//Connect Connects to the RabbitServer and to the defined ExchangeQueue
...
//Close Closes both Rabbit and Exchange connection
...
//Publish Publishes a message to the Defined ExchangeQueue
func (p *Rabbitmq) Publish(s *gen.Product) error {
...
//Health Health Endpoint of the Client
